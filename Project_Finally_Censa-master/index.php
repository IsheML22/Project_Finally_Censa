...
<main class="container mt-5 mb-5">
  ...
  <form action="Controlador/registro.php" method="POST" class="container d-flex justify-content-center align-items-center" style="height: 54vh;">
  <div class="col-12 col-md-12 col form-custom">
    <div class="mb-3">
...
<footer class="bg-warning text-dark mt-4 pt-4 pb-2 w-85">
  <div class="text-center px-3">
    <div class="row">
      <div class="col-md-6 mb-3">
        <h5 class="fw-bold">Cristiano Ronaldo Fan Page</h5>
        <p class="mb-1">Proyecto de clase desarrollado por Herlys Manes con HTML, CSS y Bootstrap</p>
